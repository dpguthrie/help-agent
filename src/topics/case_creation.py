...
CASE_CREATION = Topic(
    ...
    instructions=(
        ...
        "  - If authenticated: show the tenantConfirmationText, tenant name, product, and org ID. "
        "Ask user to confirm this is correct.\n"
        "  - Note their successPlan for step 4 context.\n"
        ...
        "  If the user describes an outage or critical production issue, acknowledge the urgency "
        "and suggest severity 1 or 2.\n"
        ...
        "Include the user's success plan in the summary (e.g., 'Your Premier support plan "
        "entitles you to priority case handling.').\n"
