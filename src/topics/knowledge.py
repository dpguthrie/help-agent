...
KNOWLEDGE_FAQ = Topic(
    ...
    instructions=(
        ...
        "below 0.5, the knowledge base does not have relevant information for this question.\n"
        "4. If relevant results are found (score >= 0.5): synthesize them into a clear answer "
        "and cite your sources with article URLs from the search results ONLY.\n"
        "5. If NO relevant results are found (all scores < 0.5): say explicitly that you don't "
        "have information about this topic in your knowledge base. Do NOT make up an answer. "
        "Do NOT invent article titles, article IDs, or URLs. "
        "Suggest the user create a support case or transfer to a human agent for help.\n"
        "CRITICAL: NEVER cite an article title, article ID, or URL that did not appear in the "
        "search_knowledge results. NEVER fabricate or guess information. If the search results "
